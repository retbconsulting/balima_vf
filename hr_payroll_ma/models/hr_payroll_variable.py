...
class HrPayrollVariable(models.Model):
    ...
    def filter_confirm(self):
        ...
        HrContract = self.env['hr.version']
    ...
    def import_file(self):
        for record in self:
            ...
            file_content_binary = base64.decodebytes(file_content)
...
class HrPayrollVariableLine(models.Model):
    ...
    contract_id = fields.Many2one(comodel_name='hr.version', string="Contrat", required=True)
